...
授权后，您可以通过 [SHOW GRANTS](SHOW%20GRANTS.md) 来查看权限授予的信息；通过 [REVOKE](REVOKE.md) 来撤销权限或角色。

在执行 GRANT 操作前，确保您已经在系统中创建了用户或角色。更多创建信息，参见 [CREATE USER](./CREATE%20USER.md) 和 [CREATE ROLE](./CREATE%20ROLE.md)。
